    ...
    return (
        ...
        <View className="flex-col items-start justify-center mt-5 px-5">
          ...
          />
            ...
            <TouchableOpacity className='absolute bottom-5 left-0 right-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-3' onPress={router.back}>
